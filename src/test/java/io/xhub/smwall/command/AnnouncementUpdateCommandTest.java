...
public class AnnouncementUpdateCommandTest {
    ...
    @Test
    public void should_ThrowConstraintViolationException_when_InvalidDescription() {
        AnnouncementAddCommand command = new AnnouncementAddCommand(
    ...
    @Test
    public void should_ThrowConstraintViolationException_when_InvalidEndDate() {
        AnnouncementAddCommand command = new AnnouncementAddCommand(
                "Valid announcement title",
                "Valid announcement description",
                Instant.now().plusSeconds(3600),
    ...
    @Test
    public void should_ThrowConstraintViolationException_when_InvalidStartDate() {
        AnnouncementAddCommand command = new AnnouncementAddCommand(
                "Valid announcement title",
                "Valid announcement description",
