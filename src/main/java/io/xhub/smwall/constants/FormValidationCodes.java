...
public class FormValidationCodes {
    public static final String DATE_AFTER_TODAY = "Announcement Date must be after today";
    public static final String INVALID_TITLE_PATTERN = "Title format is invalid.";
